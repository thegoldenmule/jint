...
namespace Jint.Native.Object
{
    public class ObjectInstance
    {
        ...
        public readonly Dictionary<string, PropertyDescriptor> Properties = new Dictionary<string, PropertyDescriptor>();
                ...
                if (current.IsDataDescriptor() != desc.IsDataDescriptor())
                {
                    ...
                    if (current.IsDataDescriptor())
                    {
                        Properties[propertyName] = current = new PropertyDescriptor(
                            ...
                            Undefined.Instance,
                            Undefined.Instance,
                            current.Enumerable.HasValue && current.Enumerable.Value.AsBoolean(),
                            current.Configurable.HasValue && current.Configurable.Value.AsBoolean());
                    }
                    else
                    {
                        Properties[propertyName] = current = new PropertyDescriptor(
